...
set yrange [P0-1.5:phase0 + 1.5]
set autoscale x

set ytics('0' phase0, '1' phase0 + 0.25, '2' phase0 + 0.5, '3' phase0 + 0.75, '4' phase0 + 1, '5' phase0+1.25, 'V1' V10, 'V2' V20, 'V3' V30, 'V4' V40, 'V5' V50, 'V6' V60, '10 cm' xe0+2, '5 cm' xe0+1, 'x 0' xe0, '300 rd/s' omega0+3, '200 rd/s' omega0+2, '100 rd/s' omega0+1, 'omega_m 0' omega0, '1 N.m' Tel0+1, 'T_{el} 0' Tel0, '-1 N.m' Tel0-1, '100kPa' rho0+1, 'rho_e 0' rho0, '100 W' P0+1, 'P_m 0' P0, '-100 W' P0-1)
set pointsize 1
